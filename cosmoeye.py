...
Original file is located at
    https://colab.research.google.com/drive/1SEWIyggQBVKhL4WaLktJ4z5jRZZt_8qY

# Exploring Solar Systems with Statistics

 we will plot a few graphs and apply statistics to the data we have! We will also try to find some interesting insights about different solar systems.
...
for planet_data in temp_suitable_planets:
  if isinstance(planet_data[8], str) and planet_data[8].lower() == "unknown":
